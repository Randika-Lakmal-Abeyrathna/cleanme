...
<html lang="en">
    ...
    <head>
        ...
        <meta name="author" content="randika lakmal">
        ...
        <!-- MetisMenu CSS -->
        <link href="<?= base_url() ?>public/metisMenu/metisMenu.min.css" rel="stylesheet">

        <!-- Custom CSS -->
        <link href="<?= base_url() ?>public/css/sb-admin-2.css" rel="stylesheet">

        <!-- Morris Charts CSS -->
        <link href="<?= base_url() ?>public/morrisjs/morris.css" rel="stylesheet">
    ...
    <body>
                ...
                <div class="col-md-4 col-md-offset-4">
                    <div class="login-panel panel panel-default">
                        ...
                        <div class="panel-body">
                            <form action="login/test" method="post" role="form">
                                    <fieldset>
        ...
        <script src="<?= base_url() ?>public/metisMenu/metisMenu.min.js"></script>
